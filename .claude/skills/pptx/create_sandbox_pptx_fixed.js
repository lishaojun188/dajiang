...
slide2.addShape(pptx.ShapeType.ellipse, {
    x: 0.6, y: 1.5, w: 2.2, h: 2.2,
    fill: { color: DJI_COLORS.RED, transparency: 20 },
    line: { color: DJI_COLORS.RED, width: 3 }
});

slide2.addText("🎯", {
    x: 1.0, y: 2.0, w: 1.4, h: 0.7,
    fontSize: 40, align: "center"
});

slide2.addText("核心定位", {
    x: 3.2, y: 1.3, w: 6, h: 0.4,
    fontSize: 18, bold: true, color: DJI_COLORS.RED,
    fontFace: "Arial"
});

slide2.addText("一个可视化的组织人才调配沙盘系统，帮助管理者通过直观的组织视角进行人才布局决策，实时模拟和评估组织能力变化。", {
    x: 3.2, y: 1.8, w: 6, h: 1.2,
    fontSize: 13, color: DJI_COLORS.WHITE,
    fontFace: "Arial", lineSpacing: 20
});

slide2.addText("A visual organizational talent deployment sandbox system that helps managers make talent layout decisions through an intuitive organizational perspective.", {
    x: 3.2, y: 3.0, w: 6, h: 0.9,
    fontSize: 11, color: DJI_COLORS.LIGHT_GRAY,
    fontFace: "Arial", italic: true, lineSpacing: 16
});
...
valueProps.forEach((prop, i) => {
    ...
    slide2.addText(prop.text, {
        x: x, y: 4.45, w: 2.0, h: 0.25,
        fontSize: 11, bold: true, color: DJI_COLORS.WHITE, align: "center"
    });
    slide2.addText(prop.sub, {
        x: x, y: 4.7, w: 2.0, h: 0.2,
        fontSize: 8, color: DJI_COLORS.LIGHT_GRAY, align: "center"
    });
});
...
const functions = [
    ...
    { num: "02", title: "能力横向对比", sub: "Capability Comparison", desc: "雷达图/柱状图对比", color: DJI_COLORS.ACCENT_ORANGE },
    { num: "03", title: "组织能力穿透", sub: "Capability Penetration", desc: "组织→团队→个人下钻", color: DJI_COLORS.ACCENT_BLUE },
    { num: "04", title: "人才档案联动", sub: "Talent Profile", desc: "一键查看人才画像", color: DJI_COLORS.SUCCESS_GREEN },
    { num: "05", title: "实时调兵模拟", sub: "Real-time Simulation", desc: "拖拽调岗实时计算", color: DJI_COLORS.WARNING_YELLOW }
];
...
functions.forEach((fn, i) => {
    ...
    slide3.addText(fn.num, {
        x: x + 0.1, y: y + 0.1, w: 0.5, h: 0.3,
        fontSize: 12, bold: true, color: fn.color,
        fontFace: "Arial"
    });

    slide3.addText(fn.title, {
        x: x + 0.1, y: y + 0.45, w: 2.8, h: 0.4,
        fontSize: 14, bold: true, color: DJI_COLORS.WHITE,
        fontFace: "Arial"
    });

    slide3.addText(fn.sub, {
        x: x + 0.1, y: y + 0.85, w: 2.8, h: 0.25,
        fontSize: 10, color: DJI_COLORS.LIGHT_GRAY,
        fontFace: "Arial", italic: true
    });

    slide3.addText(fn.desc, {
        x: x + 0.1, y: y + 1.15, w: 2.8, h: 0.6,
...
slide4.addText("功能特性", {
    x: 0.5, y: 1.3, w: 4, h: 0.35,
    fontSize: 16, bold: true, color: DJI_COLORS.RED,
    fontFace: "Arial"
});
...
// Simple org chart
slide4.addShape(pptx.ShapeType.rect, {
    x: 5.5, y: 1.3, w: 4, h: 0.7,
    fill: { color: DJI_COLORS.RED },
    line: { color: DJI_COLORS.WHITE, width: 1 }
});
slide4.addText("CEO", {
    x: 5.5, y: 1.45, w: 4, h: 0.4,
    fontSize: 13, bold: true, color: DJI_COLORS.WHITE, align: "center"
});

// Vertical line down
slide4.addShape(pptx.shapes.LINE, {
    x: 7.5, y: 2.0, w: 0, h: 0.4,
    line: { color: DJI_COLORS.WHITE, width: 2 }
});
// Horizontal line
slide4.addShape(pptx.shapes.LINE, {
    x: 6.0, y: 2.4, w: 3.0, h: 0,
    line: { color: DJI_COLORS.WHITE, width: 2 }
});
...
depts.forEach((dept, i) => {
    let x = 5.5 + i * 0.9;
    slide4.addShape(pptx.shapes.LINE, {
        x: x + 0.35, y: 2.4, w: 0, h: 0.3,
        line: { color: DJI_COLORS.WHITE, width: 2 }
    });
    slide4.addShape(pptx.ShapeType.rect, {
        x: x, y: 2.7, w: 0.7, h: 0.5,
        fill: { color: colors[i] }
    });
    slide4.addText(dept, {
        x: x, y: 2.8, w: 0.7, h: 0.3,
        fontSize: 8, bold: true, color: DJI_COLORS.DARK_GRAY, align: "center"
    });
});

// Legend
slide4.addText("颜色编码说明", {
    x: 5.5, y: 3.6, w: 4, h: 0.25,
...
legendItems.forEach((item, i) => {
    slide4.addShape(pptx.ShapeType.rect, {
        x: 5.5 + i * 1.2, y: 3.95, w: 0.25, h: 0.25,
        fill: { color: item.color }
    });
    slide4.addText(item.label, {
        x: 5.85 + i * 1.2, y: 3.95, w: 0.8, h: 0.25,
...
slide5.addText("对比维度", {
    x: 0.5, y: 1.3, w: 4, h: 0.35,
    fontSize: 16, bold: true, color: DJI_COLORS.ACCENT_ORANGE,
    fontFace: "Arial"
});
...
dimensions.forEach((dim, i) => {
    ...
    slide5.addText(dim.sub, {
        x: 0.7, y: y + 0.28, w: 2, h: 0.22,
        fontSize: 9, color: DJI_COLORS.LIGHT_GRAY, italic: true
    });
    slide5.addText(dim.items.join(" · "), {
        x: 0.7, y: y + 0.5, w: 4, h: 0.25,
        fontSize: 8, color: DJI_COLORS.WHITE
    });
});

// Radar chart area
slide5.addText("雷达图对比示例", {
    x: 5.5, y: 1.3, w: 4, h: 0.3,
    fontSize: 12, bold: true, color: DJI_COLORS.WHITE,
    fontFace: "Arial"
});

// Simple radar visualization using concentric shapes
slide5.addShape(pptx.ShapeType.pentagon, {
    x: 5.8, y: 1.7, w: 3.5, h: 3.5,
    fill: { color: DJI_COLORS.LIGHT_GRAY, transparency: 80 },
    line: { color: DJI_COLORS.LIGHT_GRAY, width: 1 }
});

slide5.addShape(pptx.ShapeType.pentagon, {
    x: 6.3, y: 2.2, w: 2.5, h: 2.5,
    fill: { color: DJI_COLORS.RED, transparency: 60 },
    line: { color: DJI_COLORS.RED, width: 2 }
});

slide5.addShape(pptx.ShapeType.pentagon, {
    x: 6.8, y: 2.7, w: 1.5, h: 1.5,
...
// Legend
slide5.addShape(pptx.ShapeType.rect, {
    x: 5.5, y: 4.7, w: 0.25, h: 0.2,
    fill: { color: DJI_COLORS.RED }
});
slide5.addText("研发部", {
    x: 5.85, y: 4.65, w: 1, h: 0.25,
    fontSize: 9, color: DJI_COLORS.WHITE
});

slide5.addShape(pptx.ShapeType.rect, {
    x: 6.8, y: 4.7, w: 0.25, h: 0.2,
    fill: { color: DJI_COLORS.ACCENT_BLUE }
});
slide5.addText("产品部", {
    x: 7.15, y: 4.65, w: 1, h: 0.25,
    fontSize: 9, color: DJI_COLORS.WHITE
});
...
const levels = [
    { name: "组织层", sub: "Organization", y: 1.3, width: 8, color: DJI_COLORS.RED },
    { name: "团队/部门层", sub: "Team/Department", y: 2.3, width: 6.5, color: DJI_COLORS.ACCENT_ORANGE },
    { name: "小组层", sub: "Group", y: 3.3, width: 5, color: DJI_COLORS.WARNING_YELLOW },
    { name: "个人层", sub: "Individual", y: 4.3, width: 3.5, color: DJI_COLORS.SUCCESS_GREEN }
];
...
levels.forEach((level, i) => {
    ...
    slide6.addShape(pptx.ShapeType.rect, {
        x: x, y: level.y, w: level.width, h: 0.75,
        fill: { color: level.color },
        line: { color: DJI_COLORS.WHITE, width: 1 }
    });

    slide6.addText(level.name, {
        x: x, y: level.y + 0.12, w: level.width, h: 0.35,
        fontSize: 14, bold: true, color: DJI_COLORS.WHITE, align: "center"
    });

    slide6.addText(level.sub, {
        x: x, y: level.y + 0.45, w: level.width, h: 0.25,
        fontSize: 9, color: DJI_COLORS.DARK_GRAY, align: "center", italic: true
    });

    if (i < levels.length - 1) {
        slide6.addShape(pptx.shapes.RIGHT_ARROW, {
            x: 4.7, y: level.y + 0.8, w: 0.6, h: 0.4,
...
vizTypes.forEach((viz, i) => {
    let y = 1.65 + i * 0.6;
    slide6.addShape(pptx.ShapeType.rect, {
        x: 0.5, y: y, w: 0.15, h: 0.45,
        fill: { color: DJI_COLORS.ACCENT_BLUE }
    });
    slide6.addText(viz.name, {
        x: 0.75, y: y, w: 1.5, h: 0.22,
        fontSize: 10, bold: true, color: DJI_COLORS.WHITE
    });
    slide6.addText(viz.desc, {
        x: 0.75, y: y + 0.22, w: 1.5, h: 0.2,
        fontSize: 8, color: DJI_COLORS.LIGHT_GRAY
    });
});
...
slide7.addText("04 人才档案联动 | Talent Profile Integration", {
    x: 0.5, y: 0.25, w: 9, h: 0.5,
    fontSize: 22, bold: true, color: DJI_COLORS.DARK_GRAY,
    fontFace: "Arial"
});
...
slide7.addShape(pptx.ShapeType.ellipse, {
    x: 1.5, y: 1.5, w: 0.8, h: 0.8,
    fill: { color: DJI_COLORS.LIGHT_GRAY }
});
slide7.addText("👤", {
    x: 1.5, y: 1.65, w: 0.8, h: 0.5,
    fontSize: 28, align: "center"
});

slide7.addText("张三", {
    x: 0.7, y: 2.4, w: 3.1, h: 0.35,
    fontSize: 16, bold: true, color: DJI_COLORS.WHITE, align: "center"
});
slide7.addText("高级产品经理 | P8", {
    x: 0.7, y: 2.75, w: 3.1, h: 0.25,
    fontSize: 10, color: DJI_COLORS.SUCCESS_GREEN, align: "center"
});
...
profileSections.forEach((section, i) => {
    ...
    slide7.addText(section.title, {
        x: 0.7, y: y, w: 3.1, h: 0.2,
        fontSize: 9, bold: true, color: DJI_COLORS.SUCCESS_GREEN
    });
    slide7.addText(section.items.join(" · "), {
        x: 0.7, y: y + 0.2, w: 3.1, h: 0.35,
        fontSize: 8, color: DJI_COLORS.WHITE
    });
});
...
slide7.addText("档案信息结构", {
    x: 4.5, y: 1.3, w: 5, h: 0.3,
    fontSize: 14, bold: true, color: DJI_COLORS.SUCCESS_GREEN,
    fontFace: "Arial"
});
...
profileFeatures.forEach((feat, i) => {
    ...
    slide7.addShape(pptx.ShapeType.rect, {
        x: 4.5, y: y, w: 0.4, h: 0.4,
        fill: { color: DJI_COLORS.MEDIUM_GRAY },
        line: { color: DJI_COLORS.SUCCESS_GREEN, width: 1 }
    });
    slide7.addText(feat.icon, {
        x: 4.5, y: y + 0.05, w: 0.4, h: 0.3,
        fontSize: 14, align: "center"
    });

    slide7.addText(feat.title, {
        x: 5.1, y: y, w: 4, h: 0.25,
        fontSize: 11, bold: true, color: DJI_COLORS.WHITE
    });
    slide7.addText(feat.desc, {
        x: 5.1, y: y + 0.25, w: 4, h: 0.35,
        fontSize: 9, color: DJI_COLORS.LIGHT_GRAY, lineSpacing: 14
    });
});
...
slide8.addText("沙盘操作", {
    x: 0.5, y: 1.3, w: 4.5, h: 0.3,
    fontSize: 14, bold: true, color: DJI_COLORS.WARNING_YELLOW,
    fontFace: "Arial"
});
...
const operations = [
    ...
    { icon: "⚖️", name: "方案对比", desc: "Compare" }
];

operations.forEach((op, i) => {
    let x = 0.5 + (i % 3) * 1.5;
    let y = 1.7 + Math.floor(i / 3) * 1.0;

    slide8.addShape(pptx.ShapeType.rect, {
        x: x, y: y, w: 1.35, h: 0.85,
        fill: { color: DJI_COLORS.MEDIUM_GRAY },
        line: { color: DJI_COLORS.WARNING_YELLOW, width: 1 }
    });
    slide8.addText(op.icon, {
        x: x, y: y + 0.08, w: 1.35, h: 0.3,
        fontSize: 20, align: "center"
    });
    slide8.addText(op.name, {
        x: x, y: y + 0.38, w: 1.35, h: 0.25,
        fontSize: 10, bold: true, color: DJI_COLORS.WHITE, align: "center"
    });
    slide8.addText(op.desc, {
        x: x, y: y + 0.62, w: 1.35, h: 0.18,
        fontSize: 7, color: DJI_COLORS.LIGHT_GRAY, align: "center", italic: true
    });
});
...
metrics.forEach((metric, i) => {
    ...
    slide8.addText(metric.name, {
        x: 5.7, y: y + 0.12, w: 2.5, h: 0.25,
        fontSize: 11, color: DJI_COLORS.WHITE
    });
    slide8.addText(metric.change, {
        x: 8.2, y: y + 0.08, w: 1, h: 0.35,
        fontSize: 14, bold: true, color: metric.color, align: "right"
    });
});
...
const scenarios = [
    {
        num: "01",
        title: "组织合并前的能力盘点",
        sub: "Pre-Merger Assessment",
        desc: "两个部门即将合并，评估合并后的人员配置和能力互补性",
        steps: ["选中待合并组织", "横向对比能力差异", "穿透查看人员构成", "模拟调整方案"]
    },
    {
        num: "02",
        title: "新项目组建",
        sub: "New Project Team",
        desc: "为新项目快速组建团队，从各组织抽调合适人才",
        steps: ["创建虚拟项目组织", "按能力标签搜索", "查看候选人位置", "模拟抽调影响"]
    },
    {
        num: "03",
        title: "关键岗位继任规划",
        ...
        steps: ["标记关键岗位", "查看能力要求", "查找匹配人才", "制定发展计划"]
    }
];
...
scenarios.forEach((scenario, i) => {
    ...
    slide9.addShape(pptx.ShapeType.rect, {
        x: x, y: 1.3, w: 3.0, h: 3.8,
        fill: { color: DJI_COLORS.MEDIUM_GRAY },
        line: { color: DJI_COLORS.RED, width: 1 }
    });

    slide9.addShape(pptx.ShapeType.ellipse, {
        x: x + 1.2, y: 1.45, w: 0.55, h: 0.55,
        fill: { color: DJI_COLORS.RED }
    });
    slide9.addText(scenario.num, {
        x: x + 1.2, y: 1.55, w: 0.55, h: 0.35,
        fontSize: 14, bold: true, color: DJI_COLORS.WHITE, align: "center"
    });

    slide9.addText(scenario.title, {
        x: x + 0.1, y: 2.05, w: 2.8, h: 0.5,
        fontSize: 13, bold: true, color: DJI_COLORS.WHITE, align: "center"
    });

    slide9.addText(scenario.sub, {
        x: x + 0.1, y: 2.55, w: 2.8, h: 0.25,
        fontSize: 8, color: DJI_COLORS.LIGHT_GRAY, align: "center", italic: true
    });

    slide9.addText(scenario.desc, {
        x: x + 0.1, y: 2.85, w: 2.8, h: 0.6,
        fontSize: 9, color: DJI_COLORS.WHITE, lineSpacing: 14
    });

    scenario.steps.forEach((step, j) => {
        slide9.addText(`${j + 1}. ${step}`, {
            x: x + 0.1, y: 3.55 + j * 0.35, w: 2.8, h: 0.3,
            fontSize: 8, color: DJI_COLORS.ACCENT_ORANGE
        });
    });
});
...
layers.forEach((layer, i) => {
    ...
    layer.components.forEach((comp, j) => {
        let cx = 2.5 + j * 1.4;
        slide10.addShape(pptx.ShapeType.rect, {
            x: cx, y: y + 0.2, w: 1.25, h: 0.75,
            fill: { color: DJI_COLORS.DARK_GRAY },
            line: { color: layer.color, width: 1 }
        });
        slide10.addText(comp, {
            x: cx, y: y + 0.4, w: 1.25, h: 0.4,
            fontSize: 8, color: DJI_COLORS.WHITE, align: "center"
        });
    });
});
...
dataReqs.forEach((req, i) => {
    ...
    slide11.addShape(pptx.ShapeType.rect, {
        x: x, y: 1.3, w: 3.0, h: 0.7,
        fill: { color: req.color }
    });
    slide11.addText(req.title, {
        x: x, y: 1.4, w: 3.0, h: 0.35,
        fontSize: 14, bold: true, color: DJI_COLORS.WHITE, align: "center"
    });
    slide11.addText(req.sub, {
        x: x, y: 1.75, w: 3.0, h: 0.25,
        fontSize: 9, color: DJI_COLORS.DARK_GRAY, align: "center", italic: true
    });

    req.items.forEach((item, j) => {
        slide11.addText(`▸ ${item}`, {
            x: x + 0.15, y: 2.2 + j * 0.55, w: 2.7, h: 0.45,
            fontSize: 10, color: DJI_COLORS.WHITE, lineSpacing: 14
        });
    });
});
...
phases.forEach((phase, i) => {
    ...
    slide12.addShape(pptx.ShapeType.rect, {
        x: x, y: 1.3, w: 2.2, h: 3.8,
        fill: { color: DJI_COLORS.MEDIUM_GRAY },
        line: { color: phase.color, width: 2 }
    });

    slide12.addShape(pptx.ShapeType.rect, {
        x: x, y: 1.3, w: 2.2, h: 0.5,
        fill: { color: phase.color }
    });
    slide12.addText(phase.phase, {
        x: x + 0.1, y: 1.38, w: 1.0, h: 0.35,
        fontSize: 11, bold: true, color: DJI_COLORS.WHITE
    });
    slide12.addText(phase.period, {
        x: x + 1.5, y: 1.38, w: 0.6, h: 0.35,
        fontSize: 12, bold: true, color: DJI_COLORS.DARK_GRAY, align: "right"
    });

    slide12.addText(phase.title, {
        x: x + 0.1, y: 1.9, w: 2.0, h: 0.35,
        fontSize: 13, bold: true, color: DJI_COLORS.WHITE, align: "center"
    });

    phase.items.forEach((item, j) => {
        slide12.addShape(pptx.ShapeType.rect, {
            x: x + 0.1, y: 2.35 + j * 0.55, w: 0.12, h: 0.4,
            fill: { color: phase.color }
        });
        slide12.addText(item, {
            x: x + 0.3, y: 2.4 + j * 0.55, w: 1.8, h: 0.35,
...
for (let i = 0; i < 3; i++) {
    slide12.addShape(pptx.shapes.RIGHT_ARROW, {
        x: 2.6 + i * 2.4, y: 3.0, w: 0.35, h: 0.25,
        fill: { color: DJI_COLORS.LIGHT_GRAY }
    });
}
...
slide13.addText("谢谢", {
    ...
    fontSize: 54, bold: true, color: DJI_COLORS.WHITE,
    fontFace: "Arial Black", align: "center"
});

slide13.addText("Thank You", {
    x: 0.5, y: 2.9, w: 9, h: 0.5,
    fontSize: 24, color: DJI_COLORS.WHITE,
    fontFace: "Arial", align: "center", italic: true
});

slide13.addText("DJI HR · 人才发展部", {
    x: 0.5, y: 4.2, w: 9, h: 0.35,
    fontSize: 12, color: DJI_COLORS.LIGHT_GRAY, align: "center"
});

slide13.addShape(pptx.ShapeType.rect, {
    x: 4.3, y: 1.1, w: 1.4, h: 0.45,
    fill: { color: DJI_COLORS.RED }
});
slide13.addText("DJI", {
    x: 4.3, y: 1.15, w: 1.4, h: 0.35,
    fontSize: 22, bold: true, color: DJI_COLORS.WHITE, align: "center"
});
